...
public class ProductService : ProductIt.ProductItBase
{
        ...
        )
        {
            if( string.IsNullOrEmpty(request.Nombre)  || string.IsNullOrEmpty(request.Descripcion) )
            {
                throw new RpcException(
                    new Status(StatusCode.InvalidArgument, "Envie los datos correctamente")
                );
            }
        ...
        )
    {
        ...
        {
            throw new RpcException(
                new Status(StatusCode.InvalidArgument, "El indice del producto debe ser mayor que cero")
            );
        }
        ...
        throw new RpcException(
            new Status(StatusCode.NotFound, $"El producto con id {request.Id} no existe")
        );
    ...
    )
    {
        ...
        {
            throw new RpcException(
                new Status(StatusCode.InvalidArgument, "Debe ingresar datos correctos")
            );
        }
        ...
        {
            throw new RpcException(
                new Status(StatusCode.NotFound, $"no existe el product con id {request.Id}")
            );
        }
    ...
    )
    {
        ...
        {
            throw new RpcException(
                new Status(StatusCode.InvalidArgument, "El indice del producto es incorrecto")
            );
        }
